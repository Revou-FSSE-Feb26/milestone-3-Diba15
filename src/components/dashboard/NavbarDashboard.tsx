...
export default function NavbarDashboard() {
    ...
    // Event listener untuk mendeteksi klik di luar elemen
    useEffect(() => {
        ...
        // Optimalisasi: Hanya daftarkan event listener jika dropdown sedang terbuka
        if (isDropdownOpen) {
    ...
    // Transisi dropdown yang mulus menggunakan Tailwind (Opacity + Scale + Translate)
    const dropdownClass = `
    ...
    return (
        <nav className="text-white p-4 flex flex-wrap gap-4 justify-between items-center relative">
            ...
            {/* Mencegah Hydration Glitch dengan menggunakan 'success' dari localStorage */}
            {!success ? (
